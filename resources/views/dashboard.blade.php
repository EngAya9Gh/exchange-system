<x-app-layout>
    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <!-- User Welcome Info -->
            <div class="bg-white rounded-[24px] shadow-soft border border-slate-50 p-8 relative overflow-hidden flex items-center justify-between transition-transform hover:-translate-y-1">
                <div class="relative z-10">
                    <div class="flex items-center gap-2 mb-2">
                        <h3 class="text-2xl font-black text-slate-800">{{ __('messages.welcome_name') }} {{ auth()->user()->name }}</h3>
                    </div>
