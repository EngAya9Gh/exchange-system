<div x-data="{
    ...
    <form x-on:submit.prevent="confirmTransfer" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- Summary Box -->
            <div class="bg-gradient-to-br from-primary-50 to-rose-50 border border-primary-100/50 rounded-[24px] p-6 flex flex-col justify-between shadow-sm relative overflow-hidden">
