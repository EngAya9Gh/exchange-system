<x-guest-layout>
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <div class="mt-5">
            ...
            <div class="relative">
                <input type="password" id="password" name="password" required autocomplete="current-password" dir="ltr" class="block w-full bg-slate-50 text-slate-800 font-semibold rounded-xl border-none focus:ring-2 focus:ring-primary-500 pl-4 pr-12 py-3.5 transition text-left" />
